...
west init -m https://git.example.com/my-repo my-downstream https://github.com/janelia-embedded/zephyr_setup/samples/freescalekinetis/zephyr-blinky ~/zephyrproject
cd ~/zephyrproject
west update
west zephyr-export
